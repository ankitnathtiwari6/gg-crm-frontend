...
const CreateLeadPage: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      <div className="flex-1 flex flex-col md:ml-20 min-w-0">
        {/* Header */}
        ...
        <div className="flex-1 flex flex-col overflow-hidden max-w-lg mx-auto w-full p-4">
          {/* Select Mode */}
          {mode === "select" && (
            <div className="grid grid-cols-2 gap-4 mt-6">
              <button
                onClick={() => setMode("chat")}
                className="flex flex-col items-center gap-3 p-8 rounded-xl border-2 border-gray-100 hover:border-indigo-300 hover:bg-indigo-50/30 transition-all group"
              >
              ...
              <button
                ...
                className="flex flex-col items-center gap-3 p-8 rounded-xl border-2 border-gray-100 hover:border-green-300 hover:bg-green-50/30 transition-all group"
              >
          ...
          {mode === "chat" && (
            <div className="flex-1 flex flex-col overflow-hidden">
              ...
              {!chatDone ? (
                <div className="pb-2 pt-3 border-t border-gray-100 flex-shrink-0">
                ...
                <div className="pb-2 pt-3 border-t border-gray-100 flex gap-3 flex-shrink-0">
                  <button
                    onClick={goBack}
                    className="flex-1 py-2.5 border border-gray-200 text-gray-600 text-sm rounded-lg hover:bg-gray-50"
                  >
